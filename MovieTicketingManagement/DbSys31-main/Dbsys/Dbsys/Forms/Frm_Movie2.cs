...
{
    public partial class Frm_Movie2 : Form
    {
        public Frm_Movie2()
        {
            InitializeComponent();
        ...
        private void Frm_Customer_Movie2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var db = new DBSYSEntities())
                {
                    ...
                    var selectedMovie = db.Movies.FirstOrDefault(m => m.MovieNo == 2);
