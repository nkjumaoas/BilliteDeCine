...
{
    public partial class Frm_Movie5 : Form
    {
        public Frm_Movie5()
        {
            InitializeComponent();
        ...
        private void Frm_Customer_Movie5_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var db = new DBSYSEntities())
                {
                    ...
                    var selectedMovie = db.Movies.FirstOrDefault(m => m.MovieNo == 5);
