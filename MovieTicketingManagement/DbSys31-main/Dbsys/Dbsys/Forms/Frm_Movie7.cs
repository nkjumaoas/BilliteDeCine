...
{
    public partial class Frm_Movie7 : Form
    {
        public Frm_Movie7()
        {
            InitializeComponent();
        ...
        private void Frm_Customer_Movie7_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var db = new DBSYSEntities())
                {
                    ...
                    var selectedMovie = db.Movies.FirstOrDefault(m => m.MovieNo == 7);
