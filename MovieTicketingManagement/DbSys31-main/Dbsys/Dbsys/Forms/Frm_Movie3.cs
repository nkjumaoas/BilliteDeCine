...
{
    public partial class Frm_Movie3 : Form
    {
        public Frm_Movie3()
        {
            InitializeComponent();
        ...
        private void Frm_Customer_Movie3_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var db = new DBSYSEntities())
                {
                    ...
                    var selectedMovie = db.Movies.FirstOrDefault(m => m.MovieNo == 3);
